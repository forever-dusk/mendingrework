...
public class JEIMendingReworkPlugin implements IModPlugin {
    ...
    public @NotNull ResourceLocation getPluginUid() {
        return ResourceLocation.fromNamespaceAndPath(MendingRework.MOD_ID, "jei_plugin");
    }
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration) {
        ...
        for (int i = 0; i < allRepairableItems.size(); i++) {
            ...
            repairRecipes.add(vanillaRecipeFactory.createAnvilRecipe(
                    ...
                    ResourceLocation.fromNamespaceAndPath(MendingRework.MOD_ID, "repair")
            ));
            ...
            if (itemsToRepair.get(i).is(ItemTags.DURABILITY_ENCHANTABLE)) {
                ...
                repairRecipes.add(vanillaRecipeFactory.createAnvilRecipe(
                        ...
                        ResourceLocation.fromNamespaceAndPath(MendingRework.MOD_ID, "repair_mending")
                ));
            }
        }
        ...
        for (int i = 0; i < allExperienceRepairableItems.size(); i++) {
            ...
            repairRecipes.add(vanillaRecipeFactory.createAnvilRecipe(
                    ...
                    ResourceLocation.fromNamespaceAndPath(MendingRework.MOD_ID, "repair_default")
            ));
